...
class BSTNode
{
    public:
        ...
        BSTNode( const DataType &nodeData, BSTNode *leftPtr, 
                                                           BSTNode *rightPtr );
...
class BSTClass
{
    public:
        ...
        void showBSTStructure( char IDChar );
        int getHeight( BSTNode<DataType> *workingPtr );
        void showBSTStructureHelper( BSTNode<DataType>* workingPtr,
                  int treeHeight, int currentRow, int printRow, bool &newLine);
    ...
    private:
        ...
        int getHeightHelper( BSTNode<DataType> *workingPtr );

        void spacePrinter( int height, bool &newLine );

        void dashPrinter( bool &newLine, int height, int dashes );
