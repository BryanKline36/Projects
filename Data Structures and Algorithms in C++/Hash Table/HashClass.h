...
class HashClass
   {
    public:
       ...
       // constructor
       HashClass(); //DONE
       HashClass( const HashClass<DataType> &copied ); //DONE

       // destructor
       ~HashClass(); //DONE

       // assignment operator
       const HashClass &operator = (const HashClass<DataType> &rhData ); //DONE

       // modifiers
       bool setTableLength( int newTableLength, bool clearListFlag,
                                           int &maxProbes, int &totalProbes ); //DONE
       void setHashLetterCount( int newHashLetterCount ); //DONE
       void setProbeAttempts( int newNumProbeAttempts ); //DONE
       ...
       //   reports probe attempts
       bool removeItem( const DataType &dataItem, int &probeAttempts ); //DONE
       ...
       void showStructure() const; //DONE

    private:

       // calls DataType hash operation
       int hash( const DataType &dataItem, int workingTableLength ) const; //DONE
       ...
       void copyList( const DataNode<DataType> *copiedList ); //DONE

       // utility for calculating quadratic probing
       int toPower( int base, int exponent ) const; //DONE
